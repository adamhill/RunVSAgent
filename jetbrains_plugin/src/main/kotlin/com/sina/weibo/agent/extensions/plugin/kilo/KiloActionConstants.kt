...
typealias KiloSupportPromptType = String
/** Type alias for prompt parameters map */
typealias KiloPromptParams = Map<String, Any?>
 ...
 */
data class KiloSupportPromptConfig(val template: String)
 ...
 *
 * Organized under the Kilo Code extension.
 */
object KiloSupportPromptConfigs {
    /**
     * Template for enhancing user prompts.
     * Instructs the AI to generate an improved version of the user's input.
     */
    val ENHANCE = KiloSupportPromptConfig(
...
${'$'}{userInput}"""
     ...
     */
    val EXPLAIN = KiloSupportPromptConfig(
...
3. Important patterns or techniques used"""
     ...
     */
    val FIX = KiloSupportPromptConfig(
...
4. Explain what was fixed and why"""
     ...
     */
    val IMPROVE = KiloSupportPromptConfig(
...
Provide the improved code along with explanations for each enhancement."""
     ...
     */
    val ADD_TO_CONTEXT = KiloSupportPromptConfig(
...
```"""
     ...
     */
    val TERMINAL_ADD_TO_CONTEXT = KiloSupportPromptConfig(
        """${'$'}{userInput}
Terminal output:
```
${'$'}{terminalContent}
```"""
     ...
     */
    val TERMINAL_FIX = KiloSupportPromptConfig(
        """${'$'}{userInput}
...
3. Explain what was fixed and why"""
     ...
     */
    val TERMINAL_EXPLAIN = KiloSupportPromptConfig(
        """${'$'}{userInput}
...
3. Expected output and behavior"""
     ...
     */
    val NEW_TASK = KiloSupportPromptConfig(
        """${'$'}{userInput}"""
    )
...
/**
 * Utility object for working with Kilo support prompts.
 * Provides methods for creating and customizing prompts based on templates.
 *
 * Organized under the Kilo Code extension.
 */
object KiloSupportPrompt {
    /**
     ...
     */
    private fun createPrompt(template: String, params: KiloPromptParams): String {
        val pattern = Regex("""\$\{(.*?)}""")
     ...
     */
    fun get(customSupportPrompts: Map<String, String>?, type: KiloSupportPromptType): String {
        return customSupportPrompts?.get(type) ?: KiloSupportPromptConfigs.configs[type]?.template ?: ""
    }
     ...
     */
    fun create(type: KiloSupportPromptType, params: KiloPromptParams, customSupportPrompts: Map<String, String>? = null): String {
